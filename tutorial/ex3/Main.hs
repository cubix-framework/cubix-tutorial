...
data Statement e l where
  ...
  BlockStmt :: e [StatementL]                         -> Statement e StatementL -- Note that nothing right now can produce terms 
                                                                                -- of sort [StatementL]. You'll fix this later.
...
-- Figure out what new sort injections are needed for that to become possible. Use `createSortInclusionType` to 
